...
Name:           ros-kilted-nodl-generator-cpp
Version:        2.0.3
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS nodl_generator_cpp package

License:        Apache-2.0
URL:            https://index.ros.org/p/nodl_generator_cpp/#kilted
...
%description
Generate an rclcpp base-node class from a NoDL document.
